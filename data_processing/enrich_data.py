...
def generate_enriched_data_paths(data_processing_dir, desired_enriched_class_size=35):
    ...
    enriched_data_dir = data_processing_dir + 'enriched_dataset\\'
    raw_class_sizes = []
...
enriched_dataset_paths = generate_enriched_data_paths(data_processing_dir=data_processing_dir, desired_enriched_class_size=35)
print(enriched_dataset_paths)
