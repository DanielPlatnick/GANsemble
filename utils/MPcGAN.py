...
def train(g_model, d_model, gan_model, dataset, latent_dim, n_epochs=100, n_batch=128):
	...
	g_model.save(f'baseline-3_MPcGAN_gen_{n_epochs}epochs.h5', include_optimizer=True)
...
# if os_name == 'Windows':
# 	gan_data_dir = "private_cGANs_for_mp\\data_processing\\baseline_resample\\"
# elif os_name == 'Darwin' or os_name == 'Linux':
# 	gan_data_dir = "data_processing/aug4_enhanced/"
# else:
...
if __name__ == '__main__':
	...
	##
	gan_data_dir = "data_processing/baseline/"
	...
	# train model
	n_epochs = 150
	# train(g_model, d_model, gan_model, dataset, latent_dim, n_epochs=n_epochs, n_batch=128)
	...
	# load model
	# model = load_model(f'baseline-1_MPcGAN_gen_{n_epochs}epochs.h5')
	# model.compile
